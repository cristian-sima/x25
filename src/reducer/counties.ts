...
const initialState = Immutable.Map(),
  ...
  getCountiesList = createSelector(getCounties, (ids) => ids.toList()),
  getCounty = (state: State, id: string) => getCounties(state).get(id),
  getCountiesSorted = createSelector(getCountiesList, (list) => list.sortBy((county) => county.get("Name")));
