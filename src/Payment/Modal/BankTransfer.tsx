...
class BankTransfer extends React.Component<BankTransferPropTypes, BankTransferStateTypes> {
  ...
  render () {
    ...
    return (<React.Fragment>
      ...
      <button className="btn btn-block btn-primary mt-4 me-1 ms-1 mb-3" onClick={this.transferIsDone} type="button">
...
const ModalBankTransfer = (props: BankTransferPropTypes) => (<SimpleModal size="lg" title="Transfer bancar">
  <BankTransfer {...props} />
</SimpleModal>);
