type CifFieldPropTypes = {
  ...
  readonly handleKeyPressed: (event: any) => void;
    ...
    return (<div className="form-group row">
      ...
      <div className="col-md-9 col-lg-6">
        <div className="input-group">
          <input
            {...input} aria-label={words.FiscalID} className={classnames("form-control form-control-lg", {
              "is-invalid": touched && error,
            })} disabled={submitting} id={name} name={name} onKeyPress={handleKeyPressed} placeholder="ex. 51584214" ref={onRegisterRef} type="text" />
          <div className="input-group-append">
            <button className="btn btn-secondary btn-lg btn-info" disabled={submitting} onClick={findDetailsByCif(input.value)} title={words.GetDataFromInternet} type="button">
