    ...
    return <div className={classnames(classForDiv, {
      "is-invalid": touched && error
        ...
        <div className={right ? right : "col-md-8"}>
          <input aria-label={label} autoFocus={autoFocus} className={classForInput} disabled={submitting} id={input.name} maxLength={size} onBlur={this.handleBlur} onChange={this.handleChange} onFocus={input.onFocus} onKeyDown={this.handleKeyDown} placeholder={placeholder} ref={onRegisterRef} tabIndex={tabIndex} type={type} value={formatValue(this.state.value, this.props.optional)} />
