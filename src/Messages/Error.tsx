...
export const ErrorMessage = ({
  message,
  onRetry,
}: ErrorMessageProps) => (<div className="container alert alert-warning">
  <div className="row">
    ...
    <div className="col-3 col-sm-3 text-right">
      {typeof onRetry === "undefined" ? null : (<button className="btn btn-primary btn-sm" onClick={onRetry} type="button">
...
export const LargeErrorMessage = ({
  ...
  details,
  itemNotFound,
}: ErrorMessageProps) => (<div className="container mt-5">
  <div className="row">
    ...
    <div className="col-md-8 col-xl-5">
      ...
      <div className="text-right mt-3">
        {typeof onRetry === "undefined" ? null : (<button className="btn btn-primary" onClick={onRetry} type="button">
          {words.TryAgain}
                                                  </button>)}
      </div>
    </div>
