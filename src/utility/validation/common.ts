...
import { isValidBankAccount, isValidCIF, isValidCNP, isValidDateStamp, isValidEmail } from "./validate";

export const validateHumanNid = (optional: boolean | null | undefined = false) => (value: string) => {
  const notValid = optional && typeof value !== "undefined" && value !== "" && !isValidCNP(value) || !optional && (typeof value === "undefined" || !isValidCNP(value)),
...
export const validateCif = (value: string) => {
  const notValid = typeof value === "undefined" || !isValidCIF(value),
...
export const validateBankAccount = (value: string) => {
  const notValid = typeof value !== "undefined" && value !== "" && !isValidBankAccount(value),
...
export const validateEmail = ({
  ...
  const notValid = optional && typeof value !== "undefined" && value !== "" && !isValidEmail(value) || !optional && (typeof value === "undefined" || !isValidEmail(value)),
...
export const validateOptionalDate = (value: string) => {
  const notValid = !(typeof value === "undefined" || value === "" || value === null || isValidDateStamp(value)),
...
export const validateDate = (value: string) => {
  const notValid = !(typeof value !== "undefined" && isValidDateStamp(value)),
    error = notValid ? words.EnterValidDate : null;
...
const isInt = (value) => !isNaN(value) && parseInt(Number(value), 10) === value && !isNaN(parseInt(value, 10)),
  ...
  getNumberRangeError = ({
    ...
    const minTense = typeof min === "number" ? words.getNumberTense(min) : "",
      maxTense = typeof max === "number" ? words.getNumberTense(max) : "",
      range = typeof min === "number" && typeof max === "number" ? ` ${words.NumberBetween} ${minTense} ${words.NumberAnd} ${maxTense}` : typeof max === "number" ? ` ${words.NumberUpTo} ${maxTense}` : typeof min === "number" ? ` ${words.NumberGreaterThan} ${minTense}` : "";
...
export const validateFloat: Checker = (props) => (value) => {
  const {
    ...
    whenOptional = optional && !(typeof value === "undefined" || value === null || validateNumberRange({
      min,
      max,
      value,
      integer,
...
const getStringTense = ({
    min,
    max,
    what,
  }) => {
    const maxTense = max ? words.getNumberTense(max) : "",
      minTense = min ? words.getNumberTense(min) : "",
      isBetween = typeof max === "number" && typeof min === "number",
      rangeError = isBetween ? `${words.NumberBetween} ${minTense} ${words.NumberAnd} ${maxTense}` : typeof max === "number" ? `${words.NumberUpTo} ${maxTense}` : typeof min === "number" ? `${words.NumberGreaterThan} ${minTense}` : "";
  ...
  validateStringRange = ({
    ...
    const length = typeof value === "undefined" ? 0 : value.length,
      hasMin = typeof min === "number",
      hasMax = typeof max === "number";
...
export const validateString: Checker = (props) => (value) => {
  const {
    ...
    whenOptional = optional && !(typeof value === "undefined" || value === null || validateStringRange({
      min,
      max,
      value,
    })),
...
export const validateSelect = (message?: string) => (value: string) => {
  const notValid = typeof value === "undefined" || value === null || value === "",
...
export const validateID = (message?: string) => (value: string) => {
  const notValid = !(typeof value === "number" && !isNaN(value)),
    error = notValid ? typeof message === "undefined" ? words.PleaseSelect : message : null;
...
export const validateFields: ValidateFields = (fields, checker) => fields.reduce((accumulator, {
  field,
  options,
}) => ({ ...accumulator,
