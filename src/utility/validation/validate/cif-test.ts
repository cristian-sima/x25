...
const valid = true,
  ...
  wrong = [
    "adsasd", // too short < 6
    "00", // too long > 10
    "00000000001", // contains other things
    "aaaaaaaaaa",
    "1450123",
    "13880060",
    "13880061",
    "13880062", // "51584214", // <-- this is good
    "13880064",
    "13880065",
    "13880066",
    "13880067",
...
wrong.map((cif) => describe(`given the wrong CIF ${cif}`, () => {
...
good.map((cif) => describe(`given the good CIF ${cif}`, () => {
  it("should be valid", () => {
